...
android {
    namespace = "com.sharpedge.compose_realm_crud"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.sharpedge.compose_realm_crud"
        minSdk = 27
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
//    implementation("androidx.activity:activity-compose:1.7.2")
//    implementation(platform("androidx.compose:compose-bom:1.6.0-alpha01"))
...
//    implementation("androidx.compose.material:material3:1.6.0-alpha01")
